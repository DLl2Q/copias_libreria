...
export default function Reports() {
  ...
  const getWeekRange = (items: Copy[]) => {
    ...
    // Obtener las fechas del reporte
  ...
  // Filtrar copias por profesor si está seleccionado
    ...
    <div className="container mx-auto p-4">
      ...
      {Object.keys(grouped).length === 0 ? (
        ...
        Object.entries(grouped)
          ...
          .map(([period, items]) => {
            // Agrupar por profesor para resumen semanal/mensual
              ...
              <div key={period} className="mb-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 mb-2">
                    ...
                    <tbody>
                      {reportType === 'daily' ? (
                        // Vista diaria: mostrar todos los detalles
                        items.map((copy) => (
                        ...
                        // Vista semanal/mensual: resumen por profesor
                ...
                <div className="bg-gray-200 p-2 rounded text-right font-bold">
                  Total: S/ {Math.round(calculateTotal(items)).toFixed(2)}
                </div>
              </div>
            )
          })
